...
onMounted(refresh);
let responsableDAnnee = "RESPONSABLE_ANNEE"
</script>
    ...
    <VTable :headers="headers" :items="data" class="table-rounded" hide-default-footer disable-sort>
      ...
      <tbody>
        <tr v-for="utilisateur in data.utilisateur" :key="utilisateur.id">
          ...
          <td class="text-center" v-if="utilisateur.role == responsableDAnnee" v-text="utilisateur.nom" />
          <td class="text-center" v-if="utilisateur.role == responsableDAnnee" v-text="utilisateur.prenom" />
          <td class="text-center" v-if="utilisateur.role == responsableDAnnee" v-text="utilisateur.role" />
