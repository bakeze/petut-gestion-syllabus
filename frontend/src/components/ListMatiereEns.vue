...
const schema = Yup.object().shape({
  ...
  heurecm: Yup.number().required('heuresCM Obligatoire ! '),
  heuretd: Yup.number().required('heuresTD Obligatoire ! '),
  foad: Yup.number().required('Formation à distance Obligatoire'),
...
<template>
  <div class="menu-container">
    <div class="menu2">
      <li class="item" id="mn3" color="primary">
        <a class="btn" href="#mn3">Trier par Année</a>

        <div class="submenu">
          <a href="#" @click.prevent="filterByFormation('FIA-3')">2021</a>
          <a href="#" @click.prevent="filterByFormation('FIA-4')">2022</a>
          <a href="#" @click.prevent="filterByFormation('FIA-5')">2023</a>
        </div>
      </li>
    </div>
    <div class="menu">
      <li class="item" id="mn1" color="primary">
        ...
        <div class="submenu">
          <a href="#" @click.prevent="ToutAfficher()">Tous
            les FIA</a>
        </div>
        <div class="submenu">
                    ...
                    <v-card-text>
                      <Form @submit="modifierMatiere" :validation-schema="schema" v-slot="{ errors }">
                        <div class="form-row">
                          ...
                          <!-- <label>Id</label> -->
                          <Field name="id" type="text" class="form-control"  :value="indexmatiere" :class="{ 'is-invalid': errors.id }" readOnly />
                      ...
                      <div class="form-row">
                        <div class="form-group col-5">
                          ...
                          <Field name="intitule"  class="form-control" :value="matiereSelectionne.intitule" :class="{ 'is-invalid': errors.intitule }" readOnly/>
                          <div class="invalid-feedback">{{ errors.intitule }}</div>
                        </div>
                        <br>
                        <div class="form-group col-5">
                          <label>Code matière</label>
                          <Field name="codematiere" type="text" :value="matiereSelectionne.codematiere" class="form-control" :class="{ 'is-invalid': errors.codematiere }" readOnly/>
                      ...
                      <div class="form-row">
                        <div class="form-group col">
                          ...
                          <Field name="heurecm" type="number" :value="matiereSelectionne.heurecm" class="form-control" :class="{ 'is-invalid': errors.heurecm }" readOnly/>
                          <div class="invalid-feedback">{{ errors.heurecm }}</div>
                        </div>
                        <br>
                        <div class="form-group col">
                          <label>Heures travaux dirigés(TD)</label>
                          <Field name="heuretd" type="number" class="form-control" :value="matiereSelectionne.heuretd" :class="{ 'is-invalid': errors.heuretd }" readOnly/>
                        ...
                        <div class="form-group col">
                          ...
                          <Field name="foad" type="number" class="form-control" :value="matiereSelectionne.foad" :class="{ 'is-invalid': errors.foad }" readOnly />
                          <div class="invalid-feedback">{{ errors.foad }}</div>
                        </div>
                        <br>
                        <div class="form-group col">
                          <label>Descriptif de l'enseignement</label>
                          <Field name="descripenseignement" type="text" class="form-control" :value="matiereSelectionne.descripenseignement" :class="{ 'is-invalid': errors.descripenseignement }" />
                          <!-- <ckeditor  :editor="ClassicEditor"  ></ckeditor> -->
                        ...
                        <div class="form-group col">
                          ...
                          <Field name="objectifpedagogique" type="text" class="form-control" :value="matiereSelectionne.objectifpedagogique" :class="{ 'is-invalid': errors.objectifpedagogique }" />
                          <!-- <ckeditor  :editor="ClassicEditor"  ></ckeditor> -->
                        ...
                        <Field name="utilisateur" as="select" class="form-control"  >
                          ...
                          <option v-for=" user in data.utilisateur" :key="user.id" :value="user.nom" disabled>{{ user.nom }}</option>
                        </Field>
                      ...
                      <div class="form-group col">
                        ...
                        <Field name="ue" as="select" class="form-control" :value="matiereSelectionne.ue" >
                          ...
                          <option v-for=" ue in data.ue" :key="ue.id" :value="ue.intitule" disabled>{{ ue.intitule }}</option>
                        </Field>
